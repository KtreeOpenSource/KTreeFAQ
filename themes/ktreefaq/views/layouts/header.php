...
<header class="main-header">
    ...
    <nav class="navbar navbar-static-top" role="navigation">
        ...
        <div class="navbar-custom-menu">
            ...
            <ul class="nav navbar-nav">
                ...
                <?php } else { ?>
                    ...
                    <li class="dropdown user user-menu">
                        <a href="<?=  Url::toRoute(['site/login']); ?>" data-toggle="control-login"><i class="glyphicon glyphicon-log-in"></i>Login</a>
                    </li>
        ...
        if ($adminSettings['logo'])
            echo Html::a(Html::img(Url::base(true) . '/upload/' . $adminSettings['logo'], ['alt' => $adminSettings['site_name']]), Url::home(true), ['class' => 'logo', 'alt' => $adminSettings['site_name']]);
